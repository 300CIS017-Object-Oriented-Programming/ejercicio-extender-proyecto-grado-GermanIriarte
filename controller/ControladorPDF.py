        ...
        for acta in controlador.actas:
            if acta.autor == acta_seleccionada:
                ...
                self.pdf.multi_cell(185, 6,
                                    txt=f"Trabajo de grado denominado: , {acta.nombre_trabajo}",
                                    align='L')
                ...
                self.pdf.cell(200, 10, txt=f"Fecha/Presentacion:                  {acta.fechaPresentacion} Tesis II", ln=1, align='L')
                ...
                for criterio in acta.criterios:
                    ...
                    self.pdf.multi_cell(185, 7, txt=f"Observaciones adicionales: {criterio.adicionales}", align='L')
                    ...
                    self.pdf.multi_cell(185, 5,
                                   ...
                                   align='L')
                    numero += 1
                    self.pdf.cell(200, 5, txt=f"Firma: {acta.jurado1}                                      Firma Jurado 2: {acta.jurado2} ",
                                  ln=2,
                                  align='C')
                self.pdf.set_font("times", 'B', size=12)
